<template>
  <main class="h-full bg-mobile-cubes md:bg-cubes">
    <a
      href="https://home.bancor.network"
      target="_blank"
    ...
    >
      ...
      <div class="flex flex-col items-start md:flex-row md:justify-center md:items-center">
    ...
    <div class="main-content flex flex-col items-center justify-around relative top-[80px] h-screen min-h-[550px] max-h-[750px]">
    ...
    links: [
      {
        id: 1,
        icon: 'vote',
        href: 'https://app.bancor.network/eth/vote/',
      },
      {
        id: 2,
        icon: 'governance',
